...
import { animeMovies } from '@/lib/mockData';
      ...
      <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-400 mb-4">
            ...
            <span>/</span>
            <span className="text-white">Hoạt Hình</span>
          </nav>
          
          <div className="flex items-center space-x-4 mb-6">
            <div className="w-1 h-8 bg-red-600 rounded"></div>
            <h1 className="text-4xl font-bold text-white">🎌 Anime Nổi Bật</h1>
          </div>
          
          <p className="text-gray-300 text-lg">
            Khám phá thế giới anime với những bộ phim hoạt hình Nhật Bản đỉnh cao
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400">
            Hiển thị {animeMovies.length} anime nổi bật
          </p>
        </div>
      </div>
    </div>
